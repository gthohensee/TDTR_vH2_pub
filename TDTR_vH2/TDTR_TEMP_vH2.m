function [Integrand,G]=TDTR_TEMP_vH2(kvectin,freq,LCTE,r_pump,r_probe,A_pump)
%TDTR_TEMP_vH2 - Computes frequency domain average temperature response to 
...
%
% Syntax:  [Integrand,G]=TDTR_TEMP_vH2(kvectin,freq,LCTE,r_pump,r_probe,A_pump)
%
% Inputs:
