...
directory = '/Users/gregoryhohensee/Documents/MATLAB/BeamOffset'; % pwd is the current directory
...
%20x - 2.65 um
   ...
   refdir = '/Users/gregoryhohensee/Documents/MATLAB/TDTR_vH2_2C/refdir'; 
   [LCTE,T_LCTE] = writeLCTE_vH2(stack(ii,:),thickness(ii,:),rhoAl,T0,Xij,refdir,P0);
   ...
   TDTR_MAIN_vH2;  % Now that all system and material parameters are
